          ...
          <SwiperSlide key={index}>
            <div className="grid grid-cols-2 gap-x-5 md:grid-cols-3 lg:grid-cols-4 lg:gap-[30px]">
              {page.productList.map((product, index) => {
                ...
                return (
                  <div
                    className="w-full max-w-[240px] h-[380px] text-left "
                    key={index}
                  >
                    <div className="border hover:border-accent rounded-[18px] w-full max-w-[215px] h-full max-h-[200px] flex  item-center justify-center mb-[15px] relative transition">
                    ...
                    <div className="font-semibold lg:text-[1.2rem]">{name} </div>
                    <div className="flex item-center gap-x-3">
                      <div> ${price}</div>
                      <div className="text-[15px] text-grey line line-through">
                        {" "}
                        ${oldPrice}
                      </div>
                    </div>
